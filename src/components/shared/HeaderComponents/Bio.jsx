...
export default function Bio() {
  return (
    <section className="container flex justify-between h-[40px] select-none max-lg:px-2">
      ...
      <div className="flex items-center justify-between gap-3 font-heading text-xs h-full">
          ...
          <span className="hidden lg:flex border-x border-[#edeef5] px-1 ">Need help? Call Us: <span className="text-accent font-bold">+ 0020 500</span></span>
