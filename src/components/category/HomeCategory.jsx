    ...
    <section className="w-[95%] sm:w-[90%]  mx-auto min-h-full lg:min-h-screen">
      <div>
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
          ...
          <div className="flex w-full sm:w-auto mt-2 justify-center items-center border-2 border-gray-400 rounded-full px-4 py-1">
            <button
        ...
        <div className="w-full  lg:h-[85vh]   xl:h-[105vh] flex flex-col md:flex-row ">
          <div className="w-full md:w-[30%] border-2 border-gray-200 flex flex-col h-full">
            <div className="relative flex-1">
              ...
              <div className="absolute top-4 left-4 sm:top-6 sm:left-6 md:top-8 md:left-8 ">
                ...
                <button className="bg-[#233A95] py-1 px-3 rounded-full text-white text-xs sm:text-sm">
                  View All
                </button>
              </div>
            </div>
            ...
            <div className="flex-1  w-full flex flex-col justify-between pb-3 text-start place-items-start">
              ...
              <div className="flex justify-start w-full px-4">
                <button className="flex items-center text-xs text-[#000] font-semibold gap-1">
                  View All
                  <img
                    src="/src/assets/icons/svgs/icon.svg"
                    alt="Right arrow"
          ...
          <div className="w-full md:w-[70%] border-2 border-l-0 border-gray-200 h-full">
            <div className="grid grid-cols-2 sm:grid-cols-3  lg:grid-cols-4 h-full">
              {Array(8)
                .fill()
                .map((_, i) => (
                  <div key={i} className="bg-white rounded-lg shadow h-full">
                    <CardCategory
